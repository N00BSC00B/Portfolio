...
export const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-start justify-center px-4 md:px-6 lg:px-8 pt-12"
    >
      <div className="container max-w-6xl mx-auto text-left z-10">
        <div className="md:flex md:items-center md:space-x-8 lg:space-x-12 xl:space-x-16">
          ...
          <motion.div
            className="flex-shrink-0 mb-8 md:mb-0 md:w-1/3 lg:w-2/5 xl:w-1/2 flex justify-center md:justify-start"
          ...
          >
            <div className="relative group">
              <motion.img
                ...
                w-48 h-48 sm:w-52 sm:h-52 md:w-56 md:h-56 lg:w-80 lg:h-80 xl:w-96 xl:h-96
            ...
            >
              <GlassmorphismCard className="p-6">
                <p className="text-base md:text-lg text-muted-foreground max-w-2xl leading-relaxed">
                  ...
                  . I build intuitive user experiences and robust systems across
                  various domains, from real-time communication and AI
